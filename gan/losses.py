...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss = bce_loss(logits_real, torch.ones(logits_real.shape).cuda().detach(), reduction='mean') + \
           bce_loss(logits_fake, torch.zeros(logits_fake.shape).cuda().detach(), reduction='mean')
