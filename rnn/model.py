...
class RNN(nn.Module):
    ...
    def forward(self, input, hidden):
        ...
        input = torch.reshape(input, (1, shape, self.hidden_size))
    ...
    def init_hidden(self, batch_size, device=None):
        ...
        hidden = (torch.zeros(self.n_layers, batch_size, self.hidden_size).to(device), torch.zeros(self.n_layers, batch_size, self.hidden_size).to(device))
